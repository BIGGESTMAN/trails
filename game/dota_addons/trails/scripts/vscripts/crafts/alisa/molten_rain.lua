...
function spellCast(keys)
	...
	Timers:CreateTimer(0, function()
		fireArrow(caster, target_point, arrow_origin_offset, enhanced)
...
function fireArrow(caster, origin, arrow_origin_offset, enhanced)
	...
	local args = {non_flat = true, enhanced = enhanced}
